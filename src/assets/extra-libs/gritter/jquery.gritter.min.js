(function (b) {
  ...
  var a = {
    ...
    _tpl_item:
      '<div post_id="gritter-item-[[number]]" class="gritter-item-wrapper [[item_class]]" style="display:none"><div class="gritter-top"></div><div class="gritter-item">[[close]][[image]]<div class="[[class_name]]">[[title]]<p>[[text]]</p></div><div style="clear:both"></div></div><div class="gritter-bottom"></div></div>',
    _tpl_wrap: '<div post_id="gritter-notice-wrapper"></div>',
    add: function (g) {
      if (typeof g == "string") {
        g = { text: g };
      }
