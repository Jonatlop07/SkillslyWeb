 ...
 * http://jqueryui.com
 * Includes: widget.js, position.js, data.js, disable-selection.js, effect.js, effects/effect-blind.js, effects/effect-bounce.js, effects/effect-clip.js, effects/effect-drop.js, effects/effect-explode.js, effects/effect-fade.js, effects/effect-fold.js, effects/effect-highlight.js, effects/effect-puff.js, effects/effect-pulsate.js, effects/effect-scale.js, effects/effect-shake.js, effects/effect-size.js, effects/effect-slide.js, effects/effect-transfer.js, focusable.js, form-reset-mixin.js, jquery-1-7.js, keycode.js, labels.js, scroll-parent.js, tabbable.js, unique-post_id.js, widgets/accordion.js, widgets/autocomplete.js, widgets/button.js, widgets/checkboxradio.js, widgets/controlgroup.js, widgets/datepicker.js, widgets/dialog.js, widgets/draggable.js, widgets/droppable.js, widgets/menu.js, widgets/mouse.js, widgets/progressbar.js, widgets/resizable.js, widgets/selectable.js, widgets/selectmenu.js, widgets/slider.js, widgets/sortable.js, widgets/spinner.js, widgets/tabs.js, widgets/tooltip.js
    ...
    (this._curInst = null),
      ...
      (this.dpDiv = n(
        t(
          "<div post_id='" +
            this._mainDivId +
            "' class='ui-datepicker ui-widget ui-widget-content_element ui-helper-clearfix ui-corner-all'></div>"
        )
      ));
  }
  function n(e) {
      ...
      uniqueId: (function () {
        ...
        return function () {
          return this.each(function () {
            this.id || (this.id = "ui-post_id-" + ++t);
          });
        };
      })(),
      removeUniqueId: function () {
        return this.each(function () {
          /^ui-post_id-\d+$/.test(this.id) && t(this).removeAttr("id");
        });
      },
    }),
    t.widget("ui.accordion", {
      ...
      _processPanels: function () {
        ...
        (this.headers = this.element.find(this.options.header)),
          ...
          this._addClass(
            ...
            "ui-helper-reset ui-widget-content_element"
          ),
      ...
      _refresh: function () {
        ...
        (this.active = this._findActive(i.active)),
          ...
          this._addClass(this.active.next(), "ui-accordion-content_element-active"),
        ...
        e.preventDefault(),
          (r && !n.collapsible) ||
            ...
            r ||
              ...
              this._addClass(a.next(), "ui-accordion-content_element-active")));
      },
      _toggle: function (e) {
        var i = e.newPanel,
      ...
      _toggleComplete: function (t) {
        var e = t.oldPanel,
          i = e.prev();
        this._removeClass(e, "ui-accordion-content_element-active"),
    ...
    t.widget("ui.menu", {
      ...
      _create: function () {
        (this.activeMenu = this.element),
          ...
          this._addClass("ui-menu", "ui-widget ui-widget-content_element"),
          this._on({
      ...
      refresh: function () {
        ...
        this._toggleClass(
          ...
          this._addClass(s, "ui-menu", "ui-widget ui-widget-content_element ui-front"),
          (e = h.add(this.element)),
          (i = e.find(this.options.items)),
          i.not(".ui-menu-item").each(function () {
            var e = t(this);
            a._isDivider(e) &&
              a._addClass(e, "ui-menu-divider", "ui-widget-content_element");
          }),
          ...
          ? "controlgroupLabel" === s
            ? ((o = e.element.find(n)),
              ...
              e._addClass(
                o,
                null,
                "ui-widget ui-widget-content_element ui-state-default"
              ),
              (i = i.concat(o.get())),
              void 0)
            : (t.fn[s] &&
        ...
        dpDiv: i
          ? n(
              t(
                "<div class='" +
                  this._inlineClass +
                  " ui-datepicker ui-widget ui-widget-content_element ui-helper-clearfix ui-corner-all'></div>"
              )
            )
          : this.dpDiv,
      };
        ...
        t.drawMonth = Z,
          ...
          h = t.inline
            ...
            : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" +
              ...
              "</button>",
          l = j
            ? "<div class='ui-datepicker-buttonpane ui-widget-content_element'>" +
              (Y ? h : "") +
              (this._isInRange(t, r)
    ...
    t.widget("ui.dialog", {
      ...
      _create: function () {
        (this.originalCss = {
          ...
          this._addClass("ui-dialog-content_element", "ui-widget-content_element"),
      ...
      _createWrapper: function () {
        (this.uiDialog = t("<div>")
          ...
          this._addClass(
            this.uiDialog,
            "ui-dialog",
            "ui-widget ui-widget-content_element ui-front"
          ),
      ...
      _createButtonPane: function () {
        (this.uiDialogButtonPane = t("<div>")),
          this._addClass(
            ...
            "ui-widget-content_element ui-helper-clearfix"
          ),
      ...
      _makeDraggable: function () {
        ...
        this.uiDialog.draggable({
          cancel: ".ui-dialog-content_element, .ui-dialog-titlebar-close",
      ...
      _makeResizable: function () {
        ...
        this.uiDialog
          .resizable({
            cancel: ".ui-dialog-content_element",
            containment: "document",
  ...
  (t.ui.ddmanager = {
    ...
    t.widget("ui.progressbar", {
      ...
      _create: function () {
        (this.oldValue = this.options.value = this._constrainedValue()),
          ...
          this._addClass("ui-progressbar", "ui-widget ui-widget-content_element"),
      ...
      _create: function () {
        (this._keySliding = !1),
          ...
          this._addClass(
            ...
            "ui-widget ui-widget-content_element"
          ),
          this._refresh(),
          (this._animateOff = !1);
      },
    ...
    t.widget("ui.tabs", {
      ...
      _create: function () {
        var e = this,
          i = this.options;
        (this.running = !1),
          this._addClass("ui-tabs", "ui-widget ui-widget-content_element"),
      ...
      _processTabs: function () {
        ...
        (this.tablist = this._getList().attr("role", "tablist")),
          ...
          this._addClass(this.panels, "ui-tabs-panel", "ui-widget-content_element"),
          i &&
    ...
    t.widget("ui.tooltip", {
      ...
      _addDescribedBy: function (e, i) {
        ...
        s.push(i),
          e
            .data("ui-tooltip-post_id", i)
            .attr("aria-describedby", t.trim(s.join(" ")));
      },
      _removeDescribedBy: function (e) {
        var i = e.data("ui-tooltip-post_id"),
          s = (e.attr("aria-describedby") || "").split(/\s+/),
          n = t.inArray(i, s);
        -1 !== n && s.splice(n, 1),
          e.removeData("ui-tooltip-post_id"),
          (s = t.trim(s.join(" "))),
      ...
      _open: function (e, i, s) {
        ...
        if (s) {
          if ((o = this._find(i)))
            return o.tooltip.find(".ui-tooltip-content_element").html(s), void 0;
          i.is("[title]") &&
            (e && "mouseover" === e.type
              ? i.attr("title", "")
              : i.removeAttr("title")),
            ...
            a.find(".ui-tooltip-content_element").html(s),
            this.liveRegion.children().hide(),
            (h = t("<div>").html(a.find(".ui-tooltip-content_element").html())),
            h.removeAttr("name").find("[name]").removeAttr("name"),
            h.removeAttr("id").find("[post_id]").removeAttr("id"),
      ...
      _tooltip: function (e) {
        ...
        return (
          this._addClass(s, "ui-tooltip-content_element"),
          this._addClass(i, "ui-tooltip", "ui-widget ui-widget-content_element"),
          i.appendTo(this._appendTo(e)),
          (this.tooltips[n] = { element: e, tooltip: i })
        );
      },
      _find: function (t) {
        var e = t.data("ui-tooltip-post_id");
