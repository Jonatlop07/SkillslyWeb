...
!(function (a, b) {
  ...
  function g(b, c) {
    ...
    e.removeData("loaded").removeData("mode").removeData("url"),
      e
        ...
        ._removeAria("hidden"),
      b
        .find(".content_element > [data-mode='async'],.content_element > [data-mode='iframe']")
        .empty();
    var f = a(
    ...
    return (
      null != g && "" !== g && f._id(g),
      f.html(b.find(".content_element").html()),
      b.after(f),
      b.remove(),
      f
    );
  ...
  function E(b, c, d, e) {
    var f = j(b, d.currentIndex),
      ...
      h = b.find(".content_element > .title");
    if (null != e) {
      var i = j(b, e);
    ...
    var e = '<{0} class="{1}">{2}</{0}>',
      ...
      h = a(
        e.format(
          ...
          "content_element " + c.clearFixCssClass,
          b.html()
        )
      ),
      i = a(
  ...
  function P(b, c, d, e, f, g) {
    var h = b.find(".content_element > .body"),
